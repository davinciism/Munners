...
export class BlogPostsDashboardComponent implements OnInit {
  ...
  constructor(private auth: AuthService, private blogPostsService: BlogPostsService, private storage: AngularFireStorage) { }
  ...
  createBlogPost(){
    ...
    setTimeout(() => (this.buttonText="Create Blog Post"), 3000)
  }
